import { createNote } from '../../data/note-api.js';
...
class InputCatatan extends HTMLElement {
  constructor() {
          ...
          <div id="myModal" class="modal">
              <div class="modal-content">
                  ...
                  <form id="inputForm">
                      ...
                      <div id="noteBodyError" class="error-message"></div>
    ...
    // Event listener untuk membuka modal saat tombol "Tambah Catatan" diklik
    ...
    // Event listener untuk memvalidasi judul catatan setiap kali input berubah
    const noteTitleInput = this.shadowRoot.getElementById("noteTitle");
    noteTitleInput.addEventListener("input", () => {
      this.validateNoteTitle();
    });

    // Event listener untuk memvalidasi isi catatan setiap kali input berubah
  ...
  onSubmit(event) {
    ...
    if (noteTitleInput.checkValidity() && noteBodyInput.checkValidity()) {
      ...
      createNote(noteTitle, noteBody).then((newNote) => {
